...
from toonygrad.helpers import prod, getenv, DEBUG
from toonygrad.device import Compiled, Compiler, CompileError, LRUAllocator
from toonygrad.renderer.cstyle import MetalRenderer
...
class MetalDevice(Compiled):
  def __init__(self, device:str):
    ...
    from toonygrad.runtime.graph.metal import MetalGraph
